        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Language = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true, defaultValue: "English"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmsSent = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    PushSent = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ChurchName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    ChurchLocation = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Visibility = table.Column<int>(type: "int", nullable: false),
                    ShowFullName = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ShowEmail = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShowPhone = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShowExactAddress = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    ShowCityState = table.Column<bool>(type: "bit", nullable: false, defaultValue: true),
                    ShowDateOfBirth = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    NotificationFrequency = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    NotifyOnBorrowRequest = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnRequestApproval = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnRequestDenial = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnDueDate = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnReturn = table.Column<bool>(type: "bit", nullable: false),
                    NotifyOnNewMessage = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()"),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BorrowerId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    LenderId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BorrowRequests_Users_LenderId",
                        column: x => x.LenderId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtensionDays = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
                    ExtensionRequested = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_IsDeleted",
                table: "BorrowRequests",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BorrowRequests_RequestedStartDate",
                table: "BorrowRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_BorrowRequestId",
                table: "Loans",
                column: "BorrowRequestId",
                unique: true,
                filter: "[BorrowRequestId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Notifications_BorrowRequestId",
                table: "Notifications",
                column: "BorrowRequestId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProfiles_ChurchName",
                table: "UserProfiles",
                column: "ChurchName");
